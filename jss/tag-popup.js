...
function doInItTreeGrid()
{
	...
	popupmygrid.imgURL = "dhtmlxSuite_v35/dhtmlxGrid/codebase/imgs/";
	popupmygrid.setHeader(",<img  style='height: 3px;' src='dhtmlxSuite_v35/dhtmlxGrid/codebase/imgs/blank.gif' >,");
