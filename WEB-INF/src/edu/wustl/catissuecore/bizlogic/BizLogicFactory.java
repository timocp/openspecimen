/**
 * <p>
 * Title: BizLogicFactory Class>
 * <p>
 * Description: BizLogicFactory is a factory for DAO instances of various domain
 * objects.
 * </p>
...
public class BizLogicFactory implements IFactory
{
	...
	private transient final Logger logger = Logger.getCommonLogger(BizLogicFactory.class);
	...
	public IBizLogic getBizLogic(String className)
	{
		...
		if (className.equals("edu.wustl.catissuecore.domain.OrderItem")
				|| className.equals("edu.wustl.catissuecore.domain.PathologicalCaseOrderItem")
				|| className.equals("edu.wustl.catissuecore.domain.ExistingSpecimenOrderItem")
				|| className.equals("edu.wustl.catissuecore.domain.DerivedSpecimenOrderItem"))
		{
			bizLogic = new OrderBizLogic();
		}
		...
		else if (className.equals("edu.wustl.catissuecore.domain.MolecularSpecimen")
				| className.equals("edu.wustl.catissuecore.domain.CellSpecimen")
				| className.equals("edu.wustl.catissuecore.domain.TissueSpecimen")
				| className.equals("edu.wustl.catissuecore.domain.FluidSpecimen"))
		{
			bizLogic = new NewSpecimenBizLogic();
		}
		...
		// For caTIES
				...
				.equals("edu.wustl.catissuecore.domain.pathology.IdentifiedSurgicalPathologyReport"))
		{
			bizLogic = new IdentifiedSurgicalPathologyReportBizLogic();
		}
		else if (className.equals("edu.wustl.catissuecore.domain.pathology.TextContent"))
		{
			bizLogic = new TextReportContentBizLogic();
				...
				.equals("edu.wustl.catissuecore.domain.pathology.DeidentifiedSurgicalPathologyReport"))
		{
			bizLogic = new DeidentifiedSurgicalPathologyReportBizLogic();
		}
		else if (className
				.equals("edu.wustl.catissuecore.domain.pathology.PathologyReportReviewParameter"))
		{
			bizLogic = new PathologyReportReviewParameterBizLogic();
		}
		else if (className
				.equals("edu.wustl.catissuecore.domain.pathology.QuarantineEventParameter"))
		{
			bizLogic = new QuarantineEventParameterBizLogic();
		}
