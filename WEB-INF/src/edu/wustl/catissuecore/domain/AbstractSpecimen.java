			...
			IActivityStatus
{
	 ...
	 */
	public abstract void setPathologicalStatus(final String pathologicalStatus);
	 ...
	 */
	public abstract void setSpecimenEventCollection(final Collection<SpecimenEventParameters> specimenEventCollection);
