...
public class ConsentDetail {
	...
	public static ConsentDetail from(Consent consent) {
	...
	public static List<ConsentDetail> from(Collection<Consent> consents) {
		return consents.stream().map(ConsentDetail::from).collect(Collectors.toList());
	}
