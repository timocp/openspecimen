...
public class CpConsentDetail extends AttributeModifiedSupport implements Mergeable<String, CpConsentDetail>, Serializable {
	...
	public static CpConsentDetail fromCpr(CollectionProtocolRegistration cpr, boolean excludePhi) {
		CpConsentDetail consent = new CpConsentDetail();
	...
	@Override
	public void merge(CpConsentDetail other) {
		ConsentTierResponseDetail response = new ConsentTierResponseDetail();
