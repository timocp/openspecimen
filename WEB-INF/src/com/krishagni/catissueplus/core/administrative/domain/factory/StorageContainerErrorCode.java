...
public enum StorageContainerErrorCode implements CatissueErrorCode {
	...
	ERRORS(1811, "Please resolve the highlighted errors."), BAD_REQUEST(1815, "Bad Request"), 
	...
	NO_FREE_POSITION(1821, "No free positions or specified position is already occupied");
