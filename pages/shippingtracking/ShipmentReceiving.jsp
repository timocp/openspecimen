...
<script language="JavaScript" type="text/javascript"
	src="jss/antiSpecAjax.js"></script>
...
<script language="JavaScript" type="text/javascript"
	src="jss/shippingtracking/shippingTracking.js"></script>
<style type="text/css">
<!--
.style1 {
	font-weight: bold
...
<body>
	<%
		String[] tdStyleClassArray = {"formFieldSized15",
													...
													<td align="left">
														<table border="0" cellpadding="3" cellspacing="2">
															...
															<tr>
																...
																<td align="left" valign="top" class="black_ar"><bean:message
																		key="shipment.senderSite"
																		bundle="msg.shippingtracking" /></td>
																<td align="left" valign="top" class="black_ar"><c:out
																		value="${shipmentReceivingForm.senderSiteName}" /> <html:hidden
																		name="shipmentReceivingForm" property="senderSiteName" />
																	<html:hidden name="shipmentReceivingForm"
																		property="senderSiteId" /></td>
																<td width="20" align="left" valign="top">&nbsp;</td>
																<td align="left" valign="top">&nbsp;</td>
																<td align="left" valign="top" class="black_ar"><bean:message
																		key="shipment.receiverSite"
																		bundle="msg.shippingtracking" /></td>
																<td align="left" valign="top" class="black_ar"><c:out
																		value="${shipmentReceivingForm.receiverSiteName}" /> 
<html:hidden																		name="shipmentReceivingForm"
																		property="receiverSiteName" /> <html:hidden
																		name="shipmentReceivingForm" property="receiverSiteId" />
																</td>
															</tr>
															<tr>
																<td align="center" valign="top" class="black_ar">&nbsp;</td>
																...
																<td align="left" valign="top" class="black_ar"><c:out
																	...
																	<html:hidden name="shipmentReceivingForm"
																		...
																		name="shipmentReceivingForm"
																		property="senderContactId" /></td>
																<td align="left" valign="top">&nbsp;</td>
																<td align="left" valign="top">&nbsp;</td>
																<td align="left" valign="top" class="black_ar"><bean:message
															...
															<tr>
																...
																<td align="left" valign="top" class="black_ar"><label>
																		<c:out value="${shipmentReceivingForm.sendDate}" /> <html:hidden
																			name="shipmentReceivingForm" property="sendDate" />
																</label></td>
																<td align="left" valign="top">&nbsp;</td>

																<td align="left" valign="top">&nbsp;</td>
																<td align="left" valign="top" class="black_ar"><bean:message
																		key="shipment.senderComments"
																		bundle="msg.shippingtracking" />:</td>
																<td align="left" valign="top" class="black_ar"><c:out
																		value="${shipmentReceivingForm.senderComments}" /> <html:hidden
																		name="shipmentReceivingForm" property="senderComments" />
																</td>
															</tr>
														</table>
													</td>
													...
													<tr>
														<td align="left" valign="top">
															<table width="100%" border="0" cellpadding="4"
																cellspacing="0">
																<tr>
																	<td height="25" colspan="12" class="tableheading"><span
																		class="black_ar_b">&nbsp; <bean:message
																				key="specimen.details" bundle="msg.shippingtracking" />
																	</span></td>
																</tr>
																<tr class="subtd">
																	<td width="5%"><input type="checkbox"
																		name="chkSelectAllSpecimens"
																		id="chkSelectAllSpecimens"
																	...
																	<td width="15%"><bean:message key="specimen.label"
																			bundle="msg.shippingtracking" /></td>
																	<td width="9%"><bean:message
																			key="shipment.specimen.biomsId"
																			bundle="msg.shippingtracking" /></td>
																	<td width="9%"><bean:message key="specimen.title"
																			bundle="msg.shippingtracking" /></td>
																	<td width="9%"><bean:message key="participant.id"
																			bundle="msg.shippingtracking" /></td>
																	<td width="9%"><bean:message key="study.id"
																			bundle="msg.shippingtracking" /></td>
																	<td width="9%"><bean:message
																			key="specimen.quantity" bundle="msg.shippingtracking" />
																	</td>
																	<td width="9%"><bean:message
																			key="shipment.received.quality"
																			bundle="msg.shippingtracking" /></td>
																	<td width="15%"><bean:message
																			key="shipment.status" bundle="msg.shippingtracking" />
																	</td>
																	<td width="15%"><bean:message
																...
																<logic:iterate id="specimenItem"
																	...
																	<tr>
																		<td class="black_ar" width="2%"><input
																			type="checkbox" name="chkSpecimenId"
																			id="chkSpecimenId"
																			value="<c:out value="${specimenItem.id}"/>" /> <html:hidden
																				name="specimenItem" property="id" indexed="true" />
																		</td>
																		<td class="black_ar" width="25%"><html:text
																				name="specimenItem" property="label" size="10"
																				indexed="true" /></td>
																		...
																		<%--BMS-3621 Update the caTissue shipment receive page to match the 2.0A shipment recieve page--%>
																		<td class="black_ar" width="9%">
																			<%--Getting the Collection Protocol from the Collection Protocol Registration and check it whether it is Arm or not--%>
																			<c:choose>
																				<c:when
																					test="${specimenItem.specimenCollectionGroup.collectionProtocolRegistration.collectionProtocol.type eq 'Arm'}">
																					<c:set var="specimenTitle" value="${specimenItem.specimenCollectionGroup.collectionProtocolRegistration.collectionProtocol.parentCollectionProtocol.parentCollectionProtocol.shortTitle}"/>
																				</c:when>
																				<c:otherwise>
																					<c:set var="specimenTitle" value="${specimenItem.specimenCollectionGroup.collectionProtocolRegistration.collectionProtocol.shortTitle}"/>
																				</c:otherwise>
																			</c:choose> <c:out value="${specimenTitle}"/>  <%-- <html:hidden name="specimenItem" property="specimenRequirement.collectionProtocolEvent.collectionProtocol.shortTitle" indexed="true" />--%>
																		</td>
																		<td class="black_ar" width="15%"><c:set
																				var="specimenClass"
																				value="${specimenItem.specimenClass}" /> <html:text
																				name="specimenItem" property="availableQuantity"
																				size="3" indexed="true" />/${specimenItem.availableQuantity}

																			<c:if test="${specimenClass == 'Tissue'}">
																				<bean:message key="specimen.units.gm"
																					bundle="msg.shippingtracking" />
																			</c:if> <c:if test="${specimenClass == 'Fluid'}">
																				<bean:message key="specimen.units.ml"
																					bundle="msg.shippingtracking" />
																			</c:if> <c:if test="${specimenClass == 'Cell'}">
																				<bean:message key="specimen.units.count"
																					bundle="msg.shippingtracking" />
																			</c:if> <c:if test="${specimenClass == 'Molecular'}">
																				<bean:message key="specimen.units.microgram"
																					bundle="msg.shippingtracking" />
																			</c:if></td>
																		<%--catissue2A fix
															     ABMS-722Specimen quality not getting saved when receiving shipment in catissue
															    Adding ReceivedQuality combobox--%>
																		<td class="black_ar" width="9%"><select
																			id="receivedQualitys_${specimenItem.id}"
																			name="receivedQualitys_${specimenItem.id}">
																				<logic:iterate id="valueList"
																					name="shipmentReceivingForm"
																					property="receivedQualityList">
																					<option value="${valueList.value}">${valueList.name}</option>
																				</logic:iterate>
																		</select></td>
																		<td class="black_ar" width="15%"><label>
																				<html:select name="specimenItem"
																					property="activityStatus" styleClass="black_ar"
																					indexed="true">
																					<html:option
																		...
																		<td class="black_ar" width="15%"><html:hidden
																				...
																				var="spClass" value="${specimenItem.specimenClass}" />
																			<jsp:useBean id="spClass" type="java.lang.String" />

																			<%
																				String operation = (String) request
																									.getAttribute(Constants.OPERATION);
																							ShipmentReceivingForm form = (ShipmentReceivingForm) request
																									.getAttribute("shipmentReceivingForm");
 	...
 	String[] labelNames = {"ID", "Pos1", "Pos2"};
 				...
 				String[] attrNames = {
 						"specimenDetails(containerId_"
 								+ ((edu.wustl.catissuecore.domain.Specimen) specimenItem)
 										.getId() + ")",
 						"specimenDetails(pos1_"
 								+ ((edu.wustl.catissuecore.domain.Specimen) specimenItem)
 										.getId() + ")",
 						"specimenDetails(pos2_"
 								+ ((edu.wustl.catissuecore.domain.Specimen) specimenItem)
 										.getId() + ")"};
 				initValues = (String[]) form
 						.getSpecimenDetails("Specimen:"
 								+ (specimenCount) + "_initialValues");
 				if (initValues == null) {
 				...
 				if (request.getAttribute("disabled") != null
 						&& request.getAttribute("disabled").equals(
 								"true")) {
 					disabled = true;
 				}

 				String specimenId = (String) request
 						.getAttribute("specimenId");
 				edu.wustl.catissuecore.domain.Specimen specimen = (edu.wustl.catissuecore.domain.Specimen) specimenItem;
 				int radioSelected = 1;
 				if (specimenId != null
 						&& !specimenId.trim().equals("")
 						&& specimenId.equals(specimen.getId()
 								.toString())) {
 					if (request.getAttribute("stContSelection") != null) {
 						radioSelected = Integer
 								.parseInt((String) request
 										.getAttribute("stContSelection"));
 					}
 				}
 				...
 				if (specimenId != null
 						...
 						&& !specimenId.equals(specimen.getId()
 								.toString())) {
 					String radioSelectedString = (String) form
 							.getSpecimenDetails("specimenStorageLocation_"
 									+ specimen.getId());
 					if (radioSelectedString != null
 							&& !radioSelectedString.trim().equals("")) {
 						radioSelected = Integer
 								.parseInt(radioSelectedString);
 					}
 ...
 %> <%=ScriptGenerator.getJSEquivalentFor(dataMap,
								rowNumber)%> <script language="JavaScript" 
type="text/javascript"	src="jss/CustomListBox.js"></script> 
<c:set	var="storageLocSelectName">specimenDetails(specimenStorageLocation_<bean:write
																					name="specimenItem" property="id" />)</c:set> <jsp:useBean
																				id="storageLocSelectName" type="java.lang.String" />
																			<c:set var="storageLocSelectId">specimenStorageLocation_<bean:write
																				...
																				styleId="<%=storageLocSelectId%>"
																				styleClass="black_ar"
																				onchange="onStorageRadioClickInSpecimen(this,${Rulecounter},false)"
																		...
																		<td width="*"><c:set var="spAutoDivName">autoDiv_<c:out
																			...
																			</c:set> <jsp:useBean id="spAutoDivName"
																				type="java.lang.String" />

																			<div Style="<%=autoDisplayStyle%>"
																				id="<%=spAutoDivName%>">
																				<table summary="testing">
																					<tr>
																						<td><ncombo:nlevelcombo
																								dataMap="<%=dataMap%>"
																								attributeNames="<%=attrNames%>"
																								tdStyleClassArray="<%=tdStyleClassArray%>"
																								initialValues="<%=initValues%>"
																								styleClass="black_new" tdStyleClass="black_new"
															...
															</div> <c:set var="spManualDivName">manualDiv_<c:out
																	value="${specimenItem.id}" />
															</c:set> <jsp:useBean id="spManualDivName"
																type="java.lang.String" />

															<div style="<%=manualDisplayStyle%>"
																id="<%=spManualDivName%>">
																	...
																	<tr>
																		<td class="groupelements"><c:set
																				var="selectedContainerName">specimenDetails(selectedContainerName_<bean:write
																					name="specimenItem" property="id" />)</c:set> <jsp:useBean
																				id="selectedContainerName" type="java.lang.String" />
																			<c:set var="selectedContainerId">selectedContainerName_<bean:write
																					name="specimenItem" property="id" />
																			</c:set> <jsp:useBean id="selectedContainerId"
																				type="java.lang.String" /> <html:text
																				styleClass="black_ar" size="20"
																				styleId="<%=selectedContainerId%>"
																		...
																		<td class="groupelements"><c:set var="pos1Name">specimenDetails(position1_<bean:write
																				...
																				var="pos1Id">position1_<bean:write
																					name="specimenItem" property="id" />
																			</c:set> <jsp:useBean id="pos1Id" type="java.lang.String" />

																			<html:text styleClass="black_ar" size="2"
																				styleId="<%=pos1Id%>" property="<%=pos1Name%>"
																				disabled="false" /></td>
																		<td class="groupelements"><c:set var="pos2Name">specimenDetails(position2_<bean:write
																				...
																				var="pos2Id">position2_<bean:write
																					name="specimenItem" property="id" />
																			</c:set> <jsp:useBean id="pos2Id" type="java.lang.String" />

																			<html:text styleClass="black_ar" size="2"
																				styleId="<%=pos2Id%>" property="<%=pos2Name%>"
																				disabled="false" /></td>
																		<td class="groupelements"><c:set
																				var="stContainerName">specimenDetails(containerId_<bean:write
																					name="specimenItem" property="id" />)</c:set> <jsp:useBean
																				id="stContainerName" type="java.lang.String" /> <c:set
																				var="stContainerId">containerId_<bean:write
																					name="specimenItem" property="id" />
																			</c:set> <jsp:useBean id="stContainerId"
																				type="java.lang.String" /> <html:hidden
																				styleId="<%=stContainerId%>"
																				property="<%=stContainerName%>" /> <c:set
																				var="frameUrl">ShowFramedPage.do?pageOf=pageOfSpecimen&amp;selectedContainerName=<c:out
																					value="${selectedContainerId}" />&amp;pos1=<c:out
																					value="${pos1Id}" />&amp;pos2=<c:out
																					value="${pos2Id}" />&amp;containerId=<c:out
																					value="${stContainerId}" /><%="&" + Constants.CAN_HOLD_SPECIMEN_CLASS
									+ "=" + spClass + "" + "&"
									+ Constants.CAN_HOLD_COLLECTION_PROTOCOL
									+ "=" + collectionProtocolId%></c:set>	<jsp:useBean id="frameUrl" 
type="java.lang.String" /> <c:set 
var="functionCall">mapButtonClickedOnReceiveShipment('newSpecimenPage',<%=selectedContainerId%>,'<%=frameUrl%>')</c:set>
																			<jsp:useBean id="functionCall"
																				type="java.lang.String" /> <c:set var="buttonName">containerMap_<bean:write
																					name="specimenItem" property="id" />
																			</c:set> <jsp:useBean id="buttonName" type="java.lang.String" />

																			<html:button styleId="mapButton_${Rulecounter}"
												...
												<table width="100%" border="0" cellpadding="4"
													...
													<tr class="subtd">
														<td width="5%" height="25"><span class="black_ar">
																...
																onClick="selectAllCheckBox('chkSelectAllContainers','chkStorgaeContainerId')">
														</span></td>
														...
														<td width="130"><b><bean:message
																	key="shipment.storage.location"
																	bundle="msg.shippingtracking" /></b></td>
														<td width="40%">&nbsp;</td>
													</tr>


													<logic:iterate id="containerItem"
														name="shipmentReceivingForm"
														property="containerCollection">
														<tr>
															...
															<td class="black_ar" width="15%"><c:out
																	...
																	name="containerItem" property="name" indexed="true" />
															</td>
															<td class="black_ar" width="15%"><c:out
																	value="${containerItem.barcode}" /> <html:hidden
																	name="containerItem" property="barcode" indexed="true" />
															</td>
															...
															<td class="black_ar" width="15%">
																<%
																	ShipmentReceivingForm form = (ShipmentReceivingForm) request
																				...
																				String[] attrNames = new String[]{
																						"containerDetails(parentContainerId_"
																								+ ((edu.wustl.catissuecore.domain.Container) containerItem)
																										.getId() + ")",
																						"containerDetails(positionDimensionOne_"
																								+ ((edu.wustl.catissuecore.domain.Container) containerItem)
																										.getId() + ")",
																						"containerDetails(positionDimensionTwo_"
																								+ ((edu.wustl.catissuecore.domain.Container) containerItem)
																										.getId() + ")"};

																				String[] initValuesContainer = new String[3];
																				List initValuesListContainer = (List) request
																						.getAttribute("containerInitValues");
																				/*if(initValuesListContainer != null)
																				{
																					initValuesContainer = (String[])initValuesListContainer.get(0);
																				}*/

																				initValuesContainer = (String[]) form
																						.getContainerDetails("Container:"
																								+ (containerCount++) + "_initialValues");
																				...
																				String containerId = (String) request
																						.getAttribute("containerObjectId");

																				if (containerId != null
																						&& !containerId.trim().equals("")
																						&& containerId.equals(container.getId()
																								.toString())) {
																					if (request.getAttribute("parentContainerSelected") != null) {
																						radioSelectedCotainer = (String) request
																								.getAttribute("parentContainerSelected");
																				...
																				if (containerId != null
																						...
																						&& !containerId.equals(container.getId()
																								.toString())) {
																					radioSelectedCotainer = (String) form
																							.getContainerDetails("containerStorageLocation_"
																									+ container.getId());
																				} else if (containerId == null) {
																					String radioSelected = (String) form
																							.getContainerDetails("containerStorageLocation_"
																									+ container.getId());
																					if (radioSelected != null
																							&& !radioSelected.trim().equals("")) {
																...
																%> <%=ScriptGenerator.getJSForOutermostDataTable()%> <%=ScriptGenerator.getJSEquivalentFor(dataMap,
								rowNumber)%> <%
																	if (dataMap == null) {
																					dataMap = new HashMap();
																				}
																...
																</c:set> <jsp:useBean id="contStLocId" type="java.lang.String" />

																<html:select property="<%=contStLocName%>"
																	styleId="<%=contStLocId%>" styleClass="black_ar"
															...
															<td class="black_ar" width="15%"><c:set
																		...
																		<tr>
																			<label> <c:set var="siteControlName">containerDetails(siteId_<bean:write
																					...
																					var="siteControlId">siteId_<bean:write
																						name="containerItem" property="id" />
																				</c:set> <jsp:useBean id="siteControlId"
																					type="java.lang.String" /> <html:select
																					property="<%=siteControlName%>"
																...
																</div> <c:set var="contParentContAutoName">parentContainerAuto_<c:out
																		value="${containerItem.id}" />
																	...
																	<table border="0" cellpadding="0" cellspacing="0"
																		...
																		<tr>
																			<ncombo:nlevelcombo dataMap="<%=dataMap%>"
																				...
																				formLabelStyle="nComboGroup" noOfEmptyCombos="3" />
																		</tr>

																		</tr>
																	</table>
																</div> <c:set var="contParentContManualName">parentContainerManual_<c:out
																		value="${containerItem.id}" />
																		...
																		<tr>
																			<td class="groupelements"><c:set
																					var="contSelectedContainerName">containerDetails(selectedContainerNameCont_<bean:write
																						name="containerItem" property="id" />)</c:set> <jsp:useBean
																					id="contSelectedContainerName"
																					type="java.lang.String" /> <c:set
																					var="contSelectedContainerId">selectedContainerNameCont_<bean:write
																						name="containerItem" property="id" />
																				</c:set> <jsp:useBean id="contSelectedContainerId"
																					type="java.lang.String" /> <html:text
																					styleClass="black_ar" size="20"
																					styleId="<%=contSelectedContainerId%>"
																					property="<%=contSelectedContainerName%>"
																					disabled="false" /></td>
																			<td class="groupelements"><c:set
																					var="contpos1Name">containerDetails(contPosition1_<bean:write
																						name="containerItem" property="id" />)</c:set> <jsp:useBean
																					id="contpos1Name" type="java.lang.String" /> <c:set
																					var="contpos1Id">contPosition1_<bean:write
																						name="containerItem" property="id" />
																				</c:set> <jsp:useBean id="contpos1Id"
																					type="java.lang.String" /> <html:text
																					styleClass="black_ar" size="2"
																					styleId="<%=contpos1Id%>"
																					property="<%=contpos1Name%>" disabled="false" /></td>
																			<td class="groupelements"><c:set
																					var="contpos2Name">containerDetails(contPosition2_<bean:write
																						name="containerItem" property="id" />)</c:set> <jsp:useBean
																					id="contpos2Name" type="java.lang.String" /> <c:set
																					var="contpos2Id">contPosition2_<bean:write
																						name="containerItem" property="id" />
																				</c:set> <jsp:useBean id="contpos2Id"
																					type="java.lang.String" /> <html:text
																					styleClass="black_ar" size="2"
																					styleId="<%=contpos2Id%>"
																			...
																			<td class="groupelements"><c:set
																					var="containerIdControlName">containerDetails(containerIdContainer_<bean:write
																						name="containerItem" property="id" />)</c:set> <jsp:useBean
																					id="containerIdControlName" type="java.lang.String" />
																				<c:set var="containerIdControlid">containerIdContainer_<bean:write
																						name="containerItem" property="id" />
																					...
																					var="contbuttonName">containerMapCont_<bean:write
																						name="containerItem" property="id" />
																				</c:set> <jsp:useBean id="contbuttonName"
																					type="java.lang.String" /> <c:set
																					var="mapButtonClickedMethodName">mapButtonClicked_<bean:write
																						name="containerItem" property="id" />()</c:set> <jsp:useBean
																					id="mapButtonClickedMethodName"
																					type="java.lang.String" /> <html:button
																					styleClass="blue_ar" property="<%=contbuttonName%>"
																					styleId="<%=contbuttonName%>"
																					onclick="<%=mapButtonClickedMethodName%>"
																					disabled="false">
																					<bean:message key="buttons.map"
																						bundle="msg.shippingtracking" />
																				...
																				<jsp:useBean id="frameUrlCont"
																					type="java.lang.String" /> <script>
													...
													<tr>
														<td height="40" colspan="6"><span class="black_ar">
																...
																src="images/shippingtracking/sep.gif" width="1"
																height="19" hspace="5" align="absmiddle"> <img
																src="images/shippingtracking/ic_reject_destroy.gif"
																alt="<bean:message key="container.reject.destroy.tooltip" bundle="msg.shippingtracking"/>"
																width="127" height="16" align="absmiddle"
																onclick="setRejectAndDestroy('container')">
														</span></td>
													</tr>
												</table>
											</td>
											...
											<table width="100%" border="0" cellpadding="4"
												...
												<tr>
													<td height="25" class="tableheading"><span
														class="black_ar_b">&nbsp;<bean:message
																key="shipment.receiver.comments"
																bundle="msg.shippingtracking" /></span><span class="style1"></span></td>
												</tr>
												<tr>
													<td height="25" class="black_ar"><span
														class="black_ar_b"> <html:textarea
																property="receiverComments" styleId="receiverComments"
																name="shipmentReceivingForm" styleClass="black_ar"
																cols="90" rows="3" />
													</span></td>
												</tr>
												<tr>
